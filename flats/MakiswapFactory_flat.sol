...
// File: makiswap-core/contracts/libraries/Math.sol
...
// File: makiswap-core/contracts/interfaces/IMakiswapCallee.sol

pragma solidity >=0.5.16;

interface IMakiswapCallee {
    function makiswapCall(address sender, uint amount0, uint amount1, bytes calldata data) external;
}
...
// File: makiswap-core/contracts/interfaces/IMigrator.sol
...
// File: makiswap-core/contracts/MakiswapPair.sol
...
contract MakiswapPair is IMakiswapPair, MakiswapHRC20 {
    ...
    function _safeTransfer(address token, address to, uint value) private {
        ...
        require(success && (data.length == 0 || abi.decode(data, (bool))), 'Makiswap: TRANSFER_FAILED');
    }
    ...
    function _update(uint balance0, uint balance1, uint112 _reserve0, uint112 _reserve1) private {
        require(balance0 <= uint112(-1) && balance1 <= uint112(-1), 'Makiswap: OVERFLOW');
...
// File: contracts/MakiswapFactory.sol
